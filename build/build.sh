...
declare -A repos_git
repos_git=(
  ["falcon-genome"]="git@github.com:FCS-holding/falcon-genome.git"
  ["blaze"]="git@github.com:FCS-holding/blaze.git"
  ["bwa-flow"]="git@github.com:FCS-holding/bwa-flow.git"
  ["minimap2"]="git@github.com:FCS-holding/minimap2.git"
  ["gatk4"]="git@github.com:FCS-holding/gatk4.git"
)
